  ...
  return (
    <div className="contents">
      ...
      {summary && !summary.configured ? (
        <p className="basis-full text-xs text-neutral-600">
      ...
      summary.whatChanged &&
      summary.nextAction ? (
        <div className="basis-full max-w-md space-y-1 rounded-md bg-neutral-50 px-2.5 py-2 text-xs leading-snug text-neutral-700">
          <p>
